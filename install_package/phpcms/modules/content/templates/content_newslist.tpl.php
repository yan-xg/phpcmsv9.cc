        ...
        <div class="table-list">
            <table width="100%">
                ...
                if(is_array($datas)) {
                    ...
                    $wap = pc_base::load_config("system","wap");
                    foreach ($datas as $r) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php
                                if($wap) {
                                    echo '<a href="'.wapurl($r['url']).'" target="_blank">';
                                    echo '<img src="'.IMG_PATH.'icon/mobile_phone.png" title="手机版"></a>';
                                }
                                ?>
                            </td>
            ...
            <div class="btn"><label for="check_box"><?php echo L('selected_all');?>/<?php echo L('cancel');?></label>
                ...
                <?php if($category['content_ishtml']) {?>
                    ...
                    <input type="button" class="button" value="推送百度" onclick="myform.action='?m=content&c=push_baidu&a=push_url&dosubmit=1&catid=<?php echo $catid;?>&steps=<?php echo $steps;?>';myform.submit();"/>
                    <input type="button" class="button" value="推送MIP" onclick="myform.action='?m=content&c=push_baidu&a=push_url&dosubmit=1&catid=<?php echo $catid;?>&steps=<?php echo $steps;?>&mip=1';myform.submit();"/>
                    <input type="button" class="button" value="导出URL" onclick="myform.action='?m=content&c=push_baidu&a=import_url&dosubmit=1&catid=<?php echo $catid;?>&steps=<?php echo $steps;?>';myform.submit();"/>
