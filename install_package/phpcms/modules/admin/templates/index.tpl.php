...
<div class="header">
    ...
    <div class="rt-col">
    	<div class="tab_style white cut_line text-r"><a href="javascript:;" onclick="lock_screen()"><img src="<?php echo IMG_PATH.'icon/lockscreen.png'?>"> <?php echo L('lockscreen')?></a><span>|</span><a href="http://www.phpcms.pro" target="_blank">PHPCMS</a><span>|</span><a href="http://www.shuyanghao.cn/index.php?app=license" target="_blank"><?php echo L('authorization')?></a><span>|</span><a href="http://www.zhoutao.org" target="_blank"><?php echo L('igenus_for_postfix')?></a><span>|</span><a href="http://help.phpcms.pro/" target="_blank"><?php echo L('help')?></a>
    <ul id="Skin">
...
function show_help(targetUrl) {
	$("#help").slideUp("slow");
	var str = '';
	$.getJSON("https://www.shuyanghao.cn/index.php?app=api&controller=index&",{op:'help',targetUrl: targetUrl},
	function(data){
		if(data!=null) {
			$("#help").slideDown("slow");
