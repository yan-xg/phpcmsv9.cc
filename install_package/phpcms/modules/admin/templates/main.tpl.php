...
<div class="col-2 col-auto">
	...
	<div class="content">
	<?php echo L('main_version')?>Phpcms <?php echo PC_VERSION?>  Release <?php echo PC_RELEASE?> [<a href="https://www.phpcms.pro/" target="_blank"><?php echo L('main_latest_version')?></a>]<br />
...
<div class="col-2 lf mr10" style="width:48%">
	...
	<?php echo L('main_product_qq')?>7634000 109567385 212722569<br />
	<?php echo L('main_product_sales')?>6045564
	</div>
</div>
...
<div class="col-2 col-auto">
	...
	<div class="content">
	<?php echo L('main_version')?>Phpcms <?php echo PC_VERSION?>  Release <?php echo PC_RELEASE?> [<a href="http://www.zhoutao.org" target="_blank"><?php echo L('main_support')?></a>]<br />
