...
// `模板1`使用
function li_pages($num, $curr_page, $perpage = 20, $urlrule = '', $array = array(),$setpages = 10) {
    if(defined('URLRULE') && $urlrule == '') {
        $urlrule = URLRULE;
        $array = $GLOBALS['URL_ARRAY'];
    } elseif($urlrule == '') {
    ...
    if($num > $perpage) {
        ...
        if($curr_page>0) {
            ...
            if($curr_page==1) {
                $multipage .= ' <li class="thisclass"><span>1</span></li>';
            } elseif($curr_page>6 && $more) {
        ...
        for($i = $from; $i <= $to; $i++) {
            if($i != $curr_page) {
                ...
                $multipage .= ' <li class="thisclass"><span>'.$i.'</span></li>';
            }
        }
        if($curr_page<$pages) {
            if($curr_page<$pages-5 && $more) {
            ...
            $multipage .= ' <li class="thisclass"><span>'.$pages.'</span></li> <li><a href="'.pageurl($urlrule, $curr_page, $array).'" class="a1">'.L('next').'</a></li>';
        } else {
            $multipage .= ' <li><a href="'.pageurl($urlrule, $pages, $array).'">'.$pages.'</a></li> <li><a href="'.pageurl($urlrule, $curr_page+1, $array).'" class="a1">'.L('next').'</a></li>';
        }
        $multipage .='</ul>';
...
// `模板2`使用
function pages_template2($num, $curr_page, $perpage = 20, $urlrule = '', $array = array(),$setpages = 10) {
    if(defined('URLRULE') && $urlrule == '') {
        $urlrule = URLRULE;
        $array = $GLOBALS['URL_ARRAY'];
    } elseif($urlrule == '') {
    ...
    if($num > $perpage) {
        ...
        $multipage .= '<a class="br sb page-numbers">'.$num.L('page_item').'</a>';
        if($curr_page>0) {
            $multipage .= ' <a href="'.pageurl($urlrule, $curr_page-1, $array).'" class="br sb page-numbers">'.L('previous').'</a>';
            if($curr_page==1) {
                $multipage .= ' <span class="br sb page-numbers current">1</span>';
            } elseif($curr_page>6 && $more) {
                $multipage .= ' <a class="br sb page-numbers" href="'.pageurl($urlrule, 1, $array).'">1</a>..';
            } else {
                $multipage .= ' <a class="br sb page-numbers" href="'.pageurl($urlrule, 1, $array).'">1</a>';
            }
        }
        for($i = $from; $i <= $to; $i++) {
            if($i != $curr_page) {
                $multipage .= ' <a class="br sb page-numbers" href="'.pageurl($urlrule, $i, $array).'">'.$i.'</a>';
            } else {
                $multipage .= ' <span class="br sb page-numbers">'.$i.'</span>';
            }
        }
        if($curr_page<$pages) {
            if($curr_page<$pages-5 && $more) {
                $multipage .= ' ..<a  class="br sb page-numbers" href="'.pageurl($urlrule, $pages, $array).'">'.$pages.'</a> <a href="'.pageurl($urlrule, $curr_page+1, $array).'" class="br sb page-numbers">'.L('next').'</a>';
            } else {
                $multipage .= ' <a class="br sb page-numbers" href="'.pageurl($urlrule, $pages, $array).'">'.$pages.'</a> <a href="'.pageurl($urlrule, $curr_page+1, $array).'" class="br sb page-numbers">'.L('next').'</a>';
            }
        } elseif($curr_page==$pages) {
            $multipage .= ' <span class="br sb page-numbers">'.$pages.'</span> <a href="'.pageurl($urlrule, $curr_page, $array).'" class="br sb page-numbers">'.L('next').'</a>';
        } else {
            $multipage .= ' <a class="br sb page-numbers" href="'.pageurl($urlrule, $pages, $array).'">'.$pages.'</a> <a href="'.pageurl($urlrule, $curr_page+1, $array).'" class="br sb page-numbers">'.L('next').'</a>';
        }
    }
